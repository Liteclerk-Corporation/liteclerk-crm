...
using easyfiscrm_api.Models;
using easyfiscrm_api.Providers;
using easyfiscrm_api.Results;
using System.Linq;

namespace easyfiscrm_api.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        {
            Data.easyfiscrmdbDataContext db = new Data.easyfiscrmdbDataContext();
